...
void main() {
  test('Verify Blossom server response structure', () async {
    ...
    try {
      ...
      if (result.cdnUrl != null) {
        ...
        if (result.cdnUrl!.contains('playlist.m3u8')) {
          ...
          Log.info('💡 We need to check if server also returns mp4Url and fallbackUrl fields');
  ...
  }, skip: 'Manual test - requires authentication. Run with: flutter test test/services/blossom_server_response_test.dart');
}
